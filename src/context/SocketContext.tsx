...
interface SocketContextType {
  ...
  sendMessage: (roomId: string, message: string, userId: string, tempId?: number | string) => void
...
export const SocketProvider = ({ children }: SocketProviderProps) => {
  ...
  const sendMessage = (roomId: string, message: string, userId: string, tempId?: number | string) => {
    if (socket) {
